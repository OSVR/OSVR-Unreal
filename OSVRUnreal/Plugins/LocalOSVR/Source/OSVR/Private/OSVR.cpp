...
void FOSVR::LoadOSVRClientKitModule()
{
    ...
    if (!bModulesLoaded)
    {
		...
		pathsToTry.Add(FPaths::ProjectPluginsDir() / "LocalOSVR/Source/OSVRClientKit/bin/Win64/");
...
#else
        TArray<FString> pathsToTry;
		pathsToTry.Add(FPaths::ProjectPluginsDir() / "LocalOSVR/Source/OSVRClientKit/bin/Win32/");
